...
/*This file includes pages of each role*/ 

class CustomerMainPage extends StatelessWidget { //customer role page
...
class RestaurantMainPage extends StatefulWidget { //restaurant role page
  final String username;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                      ...
                      children: <Widget> [
                        Container(
                          ...
                          child: RaisedButton(
                            onPressed: (){
                              Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => DriverMainPage(this.username)),
                              );
                            },
                            color: Colors.blueAccent,
                            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
                            elevation: 5,
                            child: Text('DRIVER', style: TextStyle(color: Colors.white, fontFamily: 'Opun'),),),
                        ),
                        SizedBox(
                          height: 5,
                        ),
                        Container(
                          ...
                          child: RaisedButton(
                            ...
                            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
                            elevation: 5,
                            child: Text('CUSTOMER', style: TextStyle(color: Colors.white, fontFamily: 'Opun', fontSize: 10),)),
                        ),
                        SizedBox(
                          height: 5,
                        ),
                        Container(
                          ...
                          child: RaisedButton(
                            ...
                            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
                            elevation: 5,
                            child: Text('LOG OUT', style: TextStyle(color: Colors.white, fontFamily: 'Opun'),)),
                        ),
                      ]
                    )
                  ]
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        onPressed: () {
          Navigator.push(context,MaterialPageRoute(builder: (context) => RestaurantMainPage(this.username)));
        },
      ),
      floatingActionButtonLocation: FloatingActionButtonLocation.centerDocked,
      bottomNavigationBar: BottomAppBar(
...
class RandomMenu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        if(snapshot.hasData) {
          return ListRandomMenu(menus: snapshot.data, username: this.username);
        }
        else {
          return Center(child: CircularProgressIndicator(),);
        }
...
class ListRandomMenu extends StatelessWidget {
  ...
  final String username;
  ListRandomMenu({this.menus, this.username});
                ...
                children: <Widget>[
                  Row(
                    ...
                    children: <Widget>[
                        ...
                        child: Row(
                          ...
                          children: <Widget> [
                            ...
                            IconButton(
                              ...
                              onPressed: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => NewMenu(this.username)),);
                              },
                            ),
                          ]
                        )
                      ...
                      FlatButton(
                        onPressed: (){                          
                          Navigator.push(context, MaterialPageRoute(builder: (context) => ListMenuPageForRest(this.username)),);
                        }, 
...
class RandomMenuPromo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        if(snapshot.hasData) {
          return ListRandomMenuPromo(menusPromo: snapshot.data, username: this.username);
        }
        else {
          return Center(child: CircularProgressIndicator(),);
        }
...
class ListRandomMenuPromo extends StatelessWidget {
  ...
  final String username;
  ListRandomMenuPromo({this.menusPromo, this.username});
                ...
                children: <Widget>[
                  Row(
                    ...
                    children: <Widget>[
                        ...
                        child: Row(
                          ...
                          children: <Widget> [
                            ...
                            IconButton(
                              icon: Icon(Icons.add_circle_outline), 
                              onPressed: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context) => NewPromo(this.username)),);
                              },
                            ),
                          ]
                        )
                      ...
                      FlatButton(
                        onPressed: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context) => ListMenuPromoPageForRest(this.username)),);
                        }, 
                        child: Text('see more', style: TextStyle(fontFamily: 'Opun', color: Colors.grey)))
                    ],
                  ),
